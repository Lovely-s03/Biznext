...
//   return (
//     <section className="w-full max-w-7xl mx-auto py-6 flex flex-col items-center xl:flex-row gap-6 ">
//       {/* Left Slider Section */}
...
const PromoLeaderboardSection = () => {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto py-8 px-4 flex flex-col xl:flex-row gap-8">
      {/* Left Slider Section */}
          ...
          {sliderImages.map((slide, index) => (
            <div key={index} className="flex flex-col ">
              ...
              <img
                src={slide.bottomImg}
                alt={slide.altBottom}
                className="w-full object-cover rounded-lg shadow-md mt-5"
              />
            </div>
          ))}
        </Slider>
      ...
      {/* Right Leaderboard Section */}
      <div className="w-full xl:w-1/3 bg-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col">
        <h2 className="text-lg sm:text-xl font-semibold border-b pb-3 mb-4 text-gray-800">
          Leader Board
        </h2>
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm sm:text-base">
            <thead>
              <tr className="border-b text-gray-700">
                ...
                <th className="py-2 px-2 sm:px-3 text-center">Rank</th>
                <th className="py-2 px-2 sm:px-3 text-center">Diff</th>
              </tr>
            </thead>
            <tbody>
              {leaders.map((leader, i) => (
                ...
                >
                  <td className="py-2 px-2 sm:px-3 text-gray-800 truncate">
                    {leader.name}
                  </td>
